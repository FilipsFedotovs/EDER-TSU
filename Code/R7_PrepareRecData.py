...
print(UF.TimeStamp(), bcolors.OKGREEN+"The track header data has been created successfully and written to"+bcolors.ENDC, bcolors.OKBLUE+output_id_file_location+bcolors.ENDC)
