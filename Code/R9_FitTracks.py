...
parser.add_argument('--o',help="What is the output", default='R9_DECORATED_FILE_MUON_REDUCED.csv')
...
parser.add_argument('--SimpleOutput',help="Would you like to simplify the output?", default='N')
######################################## Set variables  #############################################################
...
if SimpleOutput == 'Y':
    output_result_file_location = output_result_file_location + '_CLEAN'
