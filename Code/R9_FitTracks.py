     ...
     if UserAnswer=='R':
       ...
       for j in range(0,len(data)):
           for f in range(0,1000):
              new_output_file_location=EOS_DIR+'/EDER-TSU/Data/REC_SET/R8_R9_FilteredTracks_'+str(j)+'_'+str(f)+'.pkl'
              required_output_file_location=EOS_DIR+'/EDER-TSU/Data/REC_SET/R9_R9_CNN_Fit_Tracks_'+str(j)+'_'+str(f)+'.pkl'
