...
input_file_location=EOS_DIR+'/EDER-TSU/Data/TRAIN_SET/bM1_TRACK_SEGMENTS.csv'
...
if Mode=='R':
   ...
   if UserAnswer=='Y':
      ...
      for j in range(0,len(data)):
           ...
           SHName = AFS_DIR + '/HTCondor/SH/SH_bM2_' + str(j) + '.sh'
           SUBName = AFS_DIR + '/HTCondor/SUB/SUB_bM2_' + str(j) + '.sub'
           MSGName = AFS_DIR + '/HTCondor/MSG/MSG_bM2_' + str(j)
           ScriptName = AFS_DIR + '/Code/Utilities/bM2_GenerateTrainSeeds_Sub.py '
   ...
   for j in range(0,len(data)):
       for sj in range(0,int(data[j][2])):
           ...
           job_details = [OptionHeader, OptionLine, SHName, SUBName, MSGName, ScriptName, 1, 'EDER-TSU-M2', False,
                          False]
           output_file_location=EOS_DIR+'/EDER-TSU/Data/TRAIN_SET/bM2_M2_RawTracks_'+str(j)+'_'+str(sj)+'.csv'
           output_result_location=EOS_DIR+'/EDER-TSU/Data/TRAIN_SET/bM2_M2_RawTracks_'+str(j)+'_'+str(sj)+'_RES.csv'
        ...
        for sj in range(0,int(data[j][2])):
           ...
           if os.path.isfile(output_file_location)==False:
            ...
            for f in range(0,fractions):
             new_output_file_location=EOS_DIR+'/EDER-TSU/Data/TRAIN_SET/bM2_M3_RawTracks_'+str(j)+'_'+str(sj)+'_'+str(f)+'.csv'
