...
if args.TypeOfAnalysis == 'ALL' or args.TypeOfAnalysis == 'CNN':
    ...
    rec_data_mc_min=rec_data_mc_min.drop(['FEDRA_Seg_No'],axis=1)
    rec_data_mc_min=rec_data_mc_min.rename(columns={"x": "s_x"})
    rec_data_mc_min=rec_data_mc_min.rename(columns={"y": "s_y"})
    rec_data_mc_min=rec_data_mc_min.rename(columns={"z": "s_z"})
    ...
    rec_data_mc_max=rec_data_mc_max.drop(['FEDRA_Seg_No'],axis=1)
