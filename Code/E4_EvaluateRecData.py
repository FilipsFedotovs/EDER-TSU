...
if args.TypeOfAnalysis == 'ALL' or args.TypeOfAnalysis == 'CNN':
    ...
    rec_data_fedra['MC_Track_Rec_Len']=np.sqrt((rec_data_fedra['fedra_s_x']-rec_data_fedra['e_x'])**2+((rec_data_fedra['fedra_s_y']-rec_data_fedra['e_y'])**2)+((rec_data_fedra['fedra_s_z']-rec_data_fedra['e_z'])**2))
