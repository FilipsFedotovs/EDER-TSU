...
if args.TypeOfAnalysis == 'ALL' or args.TypeOfAnalysis == 'TRACKING':
    ...
    seg_data_segm_kpi=seg_data_segm_kpi.groupby(by=['FEDRA_Seg_ID'])['MC_Mother_Track_ID'].nunique().reset_index()
    output_file_location = EOS_DIR + '/EDER-TSU/Data/TEST_SET/E4_MC_TRACK_SEGMENTATION_STATS_AGG.csv'
    seg_data_segm_kpi.to_csv(output_file_location,index=False)
