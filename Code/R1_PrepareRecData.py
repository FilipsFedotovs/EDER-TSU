...
if args.Log=='Y':
   #try:
      ...
      UF.LogOperation(EOS_DIR+'/EDER-TSU/Data/REC_SET/R_LOG.csv', 'StartLog', [['Step_No','Step_Desc','Fake_Seeds','Truth_Seeds','Precision','Recall'],[1,'Initial Sampling',rec_rec,eval_rec,eval_rec/(rec_rec+eval_rec),1.0]])
