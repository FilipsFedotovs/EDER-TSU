...
if args.SetType=='Val':
 ...
 output_seed_file_location=EOS_DIR+'/EDER-TSU/Data/TRAIN_SET/GM4_GM5_VALIDATION_SET.pkl'
if args.SetType=='Train':
 input_seed_file_location=EOS_DIR+'/EDER-TSU/Data/TRAIN_SET/M3_M4_Train_Set_'+str(fraction)+'.pkl'
 output_seed_file_location=EOS_DIR+'/EDER-TSU/Data/TRAIN_SET/GM4_GM5_TRAIN_SET_'+str(fraction)+'.pkl'
