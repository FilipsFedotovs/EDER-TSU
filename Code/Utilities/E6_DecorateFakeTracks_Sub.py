...
tracks_1=tracks_1.rename(columns={"Segment_1": "Track_ID"})
tracks_2=tracks.drop(['Segment_1'],axis=1)
tracks_2=tracks_2.rename(columns={"Segment_2": "Track_ID"})
...
segments=pd.merge(segments, track_list, how="inner", on=["Track_ID"]) #Shrinking the Track data so just a star hit for each segment is present.
