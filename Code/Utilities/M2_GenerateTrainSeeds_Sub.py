...
data=pd.merge(data_s, data_e, how="inner", on=["FEDRA_Seg_ID",'MC_Mother_Track_ID']) #Combining datasets so for each track we know its starting and ending coordinates
del data_e
del data_s
gc.collect()
