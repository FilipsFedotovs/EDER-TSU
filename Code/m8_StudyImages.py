...
if args.Type=='Val':
 input_file_location=EOS_DIR+'/EDER-TSU/Data/TRAIN_SET/M7_M8_Validation_Set.pkl'
else:
 input_file_location=EOS_DIR+'/EDER-TSU/Data/TRAIN_SET/M7_M8_Train_Set_'+args.Type+'.pkl'
