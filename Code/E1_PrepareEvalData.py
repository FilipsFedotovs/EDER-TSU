#This simple script prepares the evaluation data for track desegmentation procedure
...
class bcolors:
    ...
    BOLD = '\033[1m'
    UNDERLINE = '\033[4m'
parser = argparse.ArgumentParser(description='This script prepares the MC tracking data for EDER-TSU desegmentation evaluation routines')
...
data=pd.read_csv(input_file_location,
            header=0,
            usecols=[PM.FEDRA_Track_ID,PM.FEDRA_Track_QUADRANT,PM.x,PM.y,PM.z,PM.MC_Track_ID,PM.MC_Event_ID])
...
track_no_data=track_no_data.drop([PM.y,PM.z,'MC_Mother_Track_ID'],axis=1)
