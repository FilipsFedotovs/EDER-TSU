...
output_file_location=EOS_DIR+'/EDER-TSU/Data/TEST_SET/E7_TRACK_SEGMENTS.csv'
...
new_combined_data['isBackground']= new_combined_data['MotherPDGList'].isin(MotherPDGList)
